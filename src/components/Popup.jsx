...
export default function Popup({ position, screenPosition, onClose, onAddDatastream }) {
  ...
  const dataSources = ['OPC UA', 'SQL', 'WebSocket', 'REST API', 'MQTT', 'Custom']
      ...
      >
        ...
        <div className='popup-content'>
          <div className='location-info'>
            <small>
              Building Location: [{position[0].toFixed(2)}, {position[1].toFixed(2)}, {position[2].toFixed(2)}]
            </small>
          </div>
          ...
          <div className='form-group'>
            ...
            <input
              ...
              type='text'
              name='unit'
              value={formData.unit || (formData.sensorType ? units[formData.sensorType] || '' : '')}
              onChange={handleInputChange}
